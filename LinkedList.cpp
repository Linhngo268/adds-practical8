...
length=0;
 ...
 LinkedList::LinkedList(int array[],int sizeof_array){
head=nullptr;
length=0;
...
LinkedList::~LinkedList(){//delete elements in the list
...
//The function both prints the value of the item (followed by a space) and returns the value of the item at the given position of the list, If beyond the size of the array, both prints std::numeric_limits < int >::max() (followed by a space) and returns std::numeric_limits< int >::max(). You should include <limits> for this. Take a look at
